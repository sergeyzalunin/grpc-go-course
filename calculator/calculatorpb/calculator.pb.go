...
type SumResponse struct {
	...
	SumResult float64 `protobuf:"fixed64,1,opt,name=sum_result,json=sumResult,proto3" json:"sum_result,omitempty"`
}
...
func (x *SumResponse) GetSumResult() float64 {
	if x != nil {
		return x.SumResult
	}
	return 0
...
var file_calculator_calculatorpb_calculator_proto_rawDesc = []byte{
	...
	0x75, 0x6d, 0x5f, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x01, 0x52,
