...
type GreetWithDedlineRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GreetWithDedlineRequest) Reset() {
	*x = GreetWithDedlineRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GreetWithDedlineRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GreetWithDedlineRequest) ProtoMessage() {}

func (x *GreetWithDedlineRequest) ProtoReflect() protoreflect.Message {
	mi := &file_greet_greetpb_greet_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GreetWithDedlineRequest.ProtoReflect.Descriptor instead.
func (*GreetWithDedlineRequest) Descriptor() ([]byte, []int) {
	return file_greet_greetpb_greet_proto_rawDescGZIP(), []int{9}
}

func (x *GreetWithDedlineRequest) GetGreeting() *Greeting {
	if x != nil {
		return x.Greeting
	}
	return nil
...
type GreetWithDedlineResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GreetWithDedlineResponse) Reset() {
	*x = GreetWithDedlineResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GreetWithDedlineResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GreetWithDedlineResponse) ProtoMessage() {}

func (x *GreetWithDedlineResponse) ProtoReflect() protoreflect.Message {
	mi := &file_greet_greetpb_greet_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GreetWithDedlineResponse.ProtoReflect.Descriptor instead.
func (*GreetWithDedlineResponse) Descriptor() ([]byte, []int) {
	return file_greet_greetpb_greet_proto_rawDescGZIP(), []int{10}
}

func (x *GreetWithDedlineResponse) GetResult() string {
	if x != nil {
		return x.Result
	}
	return ""
...
var file_greet_greetpb_greet_proto_rawDesc = []byte{
	...
	0x47, 0x72, 0x65, 0x65, 0x74, 0x57, 0x69, 0x74, 0x68, 0x44, 0x65, 0x64, 0x6c, 0x69, 0x6e, 0x65,
	...
	0x68, 0x44, 0x65, 0x64, 0x6c, 0x69, 0x6e, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x12, 0x16, 0x0a, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	...
	0x74, 0x57, 0x69, 0x74, 0x68, 0x44, 0x65, 0x64, 0x6c, 0x69, 0x6e, 0x65, 0x12, 0x1e, 0x2e, 0x67,
...
var file_greet_greetpb_greet_proto_goTypes = []interface{}{
	...
	(*GreetWithDedlineRequest)(nil),  // 9: greet.GreetWithDedlineRequest
	(*GreetWithDedlineResponse)(nil), // 10: greet.GreetWithDedlineResponse
}
var file_greet_greetpb_greet_proto_depIdxs = []int32{
	...
	0,  // 4: greet.GreetWithDedlineRequest.greeting:type_name -> greet.Greeting
	...
	9,  // 9: greet.GreetService.GreetWithDedline:input_type -> greet.GreetWithDedlineRequest
	...
	10, // 14: greet.GreetService.GreetWithDedline:output_type -> greet.GreetWithDedlineResponse
...
func file_greet_greetpb_greet_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_greet_greetpb_greet_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GreetWithDedlineRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_greet_greetpb_greet_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GreetWithDedlineResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type GreetServiceClient interface {
	...
	// Unary with Deadline.
	GreetWithDedline(ctx context.Context, in *GreetWithDedlineRequest, opts ...grpc.CallOption) (*GreetWithDedlineResponse, error)
}
...
func (c *greetServiceClient) GreetWithDedline(ctx context.Context, in *GreetWithDedlineRequest, opts ...grpc.CallOption) (*GreetWithDedlineResponse, error) {
	out := new(GreetWithDedlineResponse)
	err := c.cc.Invoke(ctx, "/greet.GreetService/GreetWithDedline", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GreetServiceServer interface {
	...
	// Unary with Deadline.
	GreetWithDedline(context.Context, *GreetWithDedlineRequest) (*GreetWithDedlineResponse, error)
}
...
func (*UnimplementedGreetServiceServer) GreetWithDedline(context.Context, *GreetWithDedlineRequest) (*GreetWithDedlineResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GreetWithDedline not implemented")
}
...
func _GreetService_GreetWithDedline_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GreetWithDedlineRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreetServiceServer).GreetWithDedline(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/greet.GreetService/GreetWithDedline",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetServiceServer).GreetWithDedline(ctx, req.(*GreetWithDedlineRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _GreetService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GreetWithDedline",
			Handler:    _GreetService_GreetWithDedline_Handler,
		},
	},
